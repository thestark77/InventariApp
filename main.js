...
const usuarioEditor = 'Username'; // TODO: asignar campo de texto importado desde el log in... cuando lo haga :v ¿Constante o variable?... creo que constante
let Items;
...
function initClient() {
	const API_KEY = 'AIzaSyAsP0ndw71kxf6olT7Pc-UVJv11MR8t6pc';
...
function criterioDeBusqueda() {
	return opcionesDeBusqueda.value;
}
